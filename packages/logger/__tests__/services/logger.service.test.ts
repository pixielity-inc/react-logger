...
describe("LoggerService", () => {
  ...
  describe("logging methods", () => {
     ...
     * 
     * This test ensures that the debug method logs messages
     * at the debug level using the default channel.
     * 
     * Expected behavior:
     * - Message is logged to default channel
     * - Context is passed correctly
     */
    it("should log debug messages", () => {
      // Arrange: Spy on the channel method
      const channelSpy = vi.spyOn(loggerService, "channel");
      
      // Act: Log a debug message
      loggerService.debug("Debug message", { key: "value" });
      
      // Assert: Channel method was called
     ...
     * 
     * This test ensures that the info method logs messages
     * at the info level using the default channel.
     * 
     * Expected behavior:
     * - Message is logged to default channel
     * - Context is passed correctly
     ...
     * 
     * This test ensures that the warn method logs messages
     * at the warn level using the default channel.
     * 
     * Expected behavior:
     * - Message is logged to default channel
     * - Context is passed correctly
     ...
     * 
     * This test ensures that the error method logs messages
     * at the error level using the default channel.
     * 
     * Expected behavior:
     * - Message is logged to default channel
     * - Context is passed correctly
     ...
     * 
     * This test ensures that the fatal method logs messages
     * at the fatal level using the default channel.
     * 
     * Expected behavior:
     * - Message is logged to default channel
     * - Context is passed correctly
